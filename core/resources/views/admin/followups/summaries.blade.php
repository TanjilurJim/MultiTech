    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                {{-- EXPORT --}}
                <a href="{{ route('admin.followups.summaries.export', request()->query()) }}"
        ...
        <div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
                ...
                <tbody>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <form class="modal-content"
                                            ...
                                            <div class="modal-body">
                                                <textarea name="summary_note" rows="5" class="form-control">{{ old('summary_note', $row->summary_note) }}</textarea>
                                            </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-4">No snapshots yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
